...
#define PORT_B_OUTPUTS (GPIO_ADC_MUX_SEL0_BIT|GPIO_ADC_MUX_SEL1_BIT|GPIO_ADC_MUX_SEL2_BIT)
#define PORT_C_OUTPUTS (GPIO_CC1050_PALE_BIT|GPIO_CC1050_PCLK_BIT|GPIO_CC1050_PDATA_BIT)
#define PORT_D_OUTPUTS (GPIO_CC1050_LDO_BIT)
...
void port_init(void)
	...
	GPIO_CLR( GPIO_CC1050_LDO_PORT,  GPIO_CC1050_LDO_PIN );
